package eni_ecole.fr.lokacarsite.ui.carbrand.details;
...
public class CarBrandModifyFragment extends Fragment {
    /**
     ...
     */
    private CarBrand mItem;

    /**
     * Mandatory empty constructor for the fragment manager to instantiate the
     * fragment (e.g. upon screen orientation changes).
     */
    public CarBrandModifyFragment() {
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(Constant.ID)) {
            ...
            mItem = new CarBrandDao(getContext()).get(getArguments().getInt(Constant.ID));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_carbrand_modify, container, false);
