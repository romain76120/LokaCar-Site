package eni_ecole.fr.lokacarsite.ui.carmodel.details;
...
public class CarModelModifyFragment extends Fragment {
    /**
     ...
     */
    private CarModel mItem;

    /**
     * Mandatory empty constructor for the fragment manager to instantiate the
     * fragment (e.g. upon screen orientation changes).
     */
    public CarModelModifyFragment() {
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(Constant.ID)) {
            ...
            mItem = new CarModelDao(getContext()).get(getArguments().getInt(Constant.ID));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_carmodel_modify, container, false);
